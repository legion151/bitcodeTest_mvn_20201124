 ...
 * This class will be exposed by frmwk_bitcodetest_20201124_instance() call in objc world
 * Use it as Facade to get access to other Framework functionalities
 */
@CustomClass("frmwk_bitcodetest_20201124Demo")
public class frmwk_bitcodetest_20201124Demo extends NSObject {
    /*
    ...
    public frmwk_bitcodetest_20201124Demo() {
    ...
    public frmwk_bitcodetest_20201124Demo(String text) {
